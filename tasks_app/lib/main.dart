...
import 'package:tasks_app/controller/task_provider.dart';
      ...
      builder: (context, themeProvider, child) {
        return MaterialApp(
          ...
          routes: {
            ...
            AppRoute.addUserRouteName: (context) => const AddUserScreen(),
            AppRoute.addAppRouteName: (context) => const AddAppScreen(),
          },
        );
      },
    );
